...
<div id="gold-section" class="flex flex-col flex-1 justify-between w-full transition-opacity duration-300 opacity-100 gap-3">
<!-- Hero Card (24K) -->
...
<div class="grid grid-cols-2 gap-3 md:gap-4">
    <!-- 22K Widget -->
    <div class="animate-fade-in-up glass-card p-3 relative overflow-hidden flex justify-between items-center h-[76px] hover:shadow-lg transition-shadow" style="animation-delay: 0.2s;">
    ...
    <!-- 20K Widget -->
    <div class="animate-fade-in-up glass-card p-3 relative overflow-hidden flex justify-between items-center h-[76px] hover:shadow-lg transition-shadow" style="animation-delay: 0.3s;">
        <div class="flex flex-col justify-center h-full z-10">
            <div class="flex items-center gap-1 mb-0.5">
...
<div class="grid grid-cols-2 gap-3 md:gap-4">
    <!-- 18K Widget -->
    <div class="animate-fade-in-up glass-card p-3 relative overflow-hidden flex justify-between items-center h-[76px] hover:shadow-lg transition-shadow" style="animation-delay: 0.4s;">
        <div class="flex flex-col justify-center h-full z-10">
            <div class="flex items-center gap-1 mb-0.5">
    ...
    <!-- 14K Widget -->
    <div class="animate-fade-in-up glass-card p-3 relative overflow-hidden flex justify-between items-center h-[76px] hover:shadow-lg transition-shadow" style="animation-delay: 0.5s;">
        <div class="flex flex-col justify-center h-full z-10">
            <div class="flex items-center gap-1 mb-0.5">
...
<div class="flex justify-center">
    <div class="w-full md:w-[90%] max-w-2xl">
        <div class="animate-fade-in-up glass-card p-3 relative overflow-hidden flex items-center justify-between hover:shadow-lg transition-shadow h-[76px]" style="animation-delay: 0.6s;">
